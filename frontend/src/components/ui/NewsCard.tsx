...
const NewsCard: React.FC<NewsCardProps> = ({ item, isNewsPage }) => {
  return (
    <div className={`${isNewsPage ? ` mb-4` : "mb-4 md:max-w-[400px]"} md:max-h-fit overflow-auto custom-scrollbar ml-4 p-4 btn-bg rounded inline-flex flex-col min-w-[200px] text-swich`}>
